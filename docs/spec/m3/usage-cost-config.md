...
> 1000 sen → **1200 sen** に修正（下表参照）。上限 10000 sen なら実質最大 **8 回（16 枚）**
> 程度に制限される。なお、旧 Imagen 4 ($0.04/枚) より Nano Banana 2 Lite ($0.034/枚) の方が
> 単価は約15%安い。旧 1000 sen の値は、そもそも旧 Imagen 4 の実コスト（4枚 = $0.16 ≈ 22〜26円、
> 137〜161円/USD の変動幅）に対して過小だった見積もり誤差であり、今回のモデル切替が原因ではない。
>
