...
- Related ADR: [ADR-0001](./0001-local-first-architecture.md) §Consequences (緊急対応 + max-instances=2 + 法務確認 (ADR-0001 2026-06-21 更新で Tier 0/1 は自己整備で公開可、Tier 2 開始時に再評価)) / [ADR-0002](./0002-dev-prod-deploy-flow.md) (dev → prod 運用フロー)
- Supersedes: なし
- Superseded by: なし
...
- [ADR-0001](./0001-local-first-architecture.md) §Consequences (緊急対応 + max-instances=2 + 法務確認 (ADR-0001 2026-06-21 更新で Tier 0/1 は自己整備で公開可、Tier 2 開始時に再評価)、本 ADR でも継承)
