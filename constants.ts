...
export const helpContent = {
    ...
    characterChart: {
        title: "キャラクター相関図の使い方",
        description: "登場人物同士の関係性を線でつなぎ、視覚的に整理する機能です。誰と誰が仲が良いか、敵対しているかを一目で把握でき、AIもこの関係性を理解してキャラクター同士の会話を生成します。",
        sections: [
            { heading: "モードの切り替え", body: "上部の「移動」「追加」「削除」ボタンで操作モードを切り替えます。やりたい操作に応じてモードを選んでください。", useCase: "操作を間違えないように、目的のモードへ切り替えたい時。" },
            { heading: "キャラクターの配置（移動モード）", body: "「移動」モードでキャラクターのカードをドラッグすると、自由に配置を変えられます。関係が分かりやすいレイアウトに整えましょう。", useCase: "登場人物が増えて、見やすく整理したい時。" },
            { heading: "関係性の追加（追加モード）", body: "「追加」モードでキャラクターを2人順番にクリックすると、その間に関係性の線が作成されます。「ライバル」「親子」「片思い」などのラベルと色も同時に設定できます。", useCase: "新しい人間関係を登録したい時。" },
            { heading: "関係性の削除（削除モード）", body: "「削除」モードに切り替えてから、消したい関係の線をクリックすると、その関係性が削除されます。", useCase: "関係が変わった時や、間違えて作成してしまった時。" },
            { heading: "AIへの活用", body: "ここで作成した関係性はAIが物語を書く際に参照されます。「ライバル」関係のキャラ同士であれば、それらしい掛け合いを生成してくれます。", useCase: "キャラ同士の会話を、関係性に沿って自然に書かせたい時。" }
        ]
    },
    timeline: {
        title: "タイムラインの使い方",
        description: "物語の出来事を時系列で並べて整理する機能です。「いつ」「どこで」「誰が」「何をしたか」をカードで管理でき、伏線や時系列の矛盾を防ぐのに役立ちます。",
        sections: [
            { heading: "新規イベントの作成", body: "「+ 新規イベントを作成」を押すと、新しいイベントカードが追加されます。日時、場所、関係者、内容を入力しましょう。", useCase: "物語の重要な出来事を時系列に記録したい時。" },
            { heading: "レーンによる並列管理", body: "「+ 新しいレーンを追加」を押すと、新しいレーン（列）が作成されます。「主人公の動き」「敵の動き」を別レーンで管理すれば、複数の物語線が同時進行する話も整理しやすくなります。", useCase: "視点が複数あるシーンや、群像劇を書く時。" },
            { heading: "イベントの編集・並び替え", body: "カードをドラッグして時系列順に並び替えたり、別のレーンに移動したりできます。クリックすれば内容も編集できます。", useCase: "プロットを練り直したい時や、時系列を再構成したい時。" },
            { heading: "レーンの削除", body: "レーンを削除すると、そのレーン内のすべてのイベントもまとめて削除されます。誤操作を防ぐため、削除前に確認ダイアログが表示されます。", useCase: "不要になった物語線を整理したい時。" },
            { heading: "矛盾チェック・伏線管理", body: "出来事を時系列で並べることで「この時点でこのキャラはまだ生まれていない」といった矛盾を防げます。伏線を張るタイミングの調整にも便利です。", useCase: "長編小説で、設定の整合性を保ちたい時。" }
        ]
    },
    knowledgeBase: {
        title: "ナレッジベースの使い方",
